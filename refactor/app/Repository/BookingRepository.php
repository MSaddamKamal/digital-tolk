...
//        $jobs = TeHelper::convertJobIdsInObjs($job_ids);
    ...
    public function updateJob($id, $data, $cuser)
    {
        ...
        if (isset($changeStatus['statusChanged'])) {
            /*since the changeStatus function will not return array
            if the requested status and  old status are same so the
            error of undefined index can occur otherwise try refactoring
...
//        }
//        return false;
//        return false is of no use because due to if and else statements the program will always return true
    }
...
//        return null or return ['error', 'Failed'];
